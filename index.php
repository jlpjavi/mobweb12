...
if(isset($_POST['signup'])){
	...
	if(empty($sex)){ $action['result'] = 'error'; array_push($text,'You forgot your sex'); }
	if(empty($birthdate)){ $action['result'] = 'error'; array_push($text,'You forgot your birth date'); }
	...
	if($action['result'] != 'error'){
		...
		//add to the database
		$add = mysql_query("INSERT INTO `players` VALUES(NULL,'$username','$password',". $birthdate['2'] .",". $birthdate['1'] .",". $birthdate['0'] .",'$sex','$email',0,0)");
    ...
    <fieldset>
    	...
    	<ul>
			...
			<li>
				...
				<input type="text" name="birth_date" value="MM-DD-YYYY" id="birth_date">
			</li>
    		<li>
